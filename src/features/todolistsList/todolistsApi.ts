...
export const todolistsApi = {
  ...
  updateTodolist(arg: UpdateTodolistTitleArgType) {
    return instance.put<UpdateTodolistTitleArgType>(`todo-lists/${arg.id}`, { title: arg.title })
  },
  getTasks(todolistId: string) {
    return instance.get<GetTasksResponse>(`todo-lists/${todolistId}/tasks`)
  },
  deleteTask(arg: RemoveTaskArgType) {
    return instance.delete<TaskType>(`todo-lists/${arg.todolistId}/tasks/${arg.taskId}`)
  },
  createTask(arg: AddTaskArgType) {
    return instance.post<TaskType>(`todo-lists/${arg.todolistId}/tasks`, { title: arg.title })
  },
